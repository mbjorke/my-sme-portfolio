...
export function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" className="relative z-10 py-16 md:py-24 bg-background/20">
      <div className="flex flex-col items-center px-4 mx-auto">
        <div className="relative z-10 mb-12 w-full text-center">
          ...
          <div className="mx-auto w-20 h-1 bg-accent"></div>
        </div>
          ...
          <Carousel
            ...
            renderItem={(testimonial: Testimonial) => (
              <div className="h-full">
                <Card variant="primary" className="relative h-full p-0 group">
                  <CardContent className="h-full flex flex-col">
                    <div className="flex flex-col items-center h-full md:flex-row md:items-start">
                      <div className="relative z-0 flex-shrink-0 mb-6 md:mb-0 md:mr-8">
                        <Quote
                      ...
                      <div className="flex-1 mt-6 min-h-[200px]">
                        <blockquote className="relative z-10 mb-6 text-lg md:text-xl text-foreground">
                          &quot;{testimonial.quote}&quot;
                        </blockquote>
                        <div>
