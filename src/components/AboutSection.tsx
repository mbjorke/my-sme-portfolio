    ...
    <section className="py-20 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
        {siteConfig.teamMembers.map((member, idx) => (
          <Card key={idx} className="h-full flex flex-col items-center justify-between rounded-2xl shadow-lg border border-border transition-all hover:shadow-xl hover:border-primary/20">
