...
export function HowSection() {
  ...
  return (
    ...
    >
      <h2 className="text-lg font-medium text-secondary mb-2 tracking-tight">{hero.subheading}</h2>
      <h1 className="text-5xl md:text-6xl font-medium text-primary mb-4 tracking-tight leading-tight">
        {hero.heading} <span className="text-accent">{hero.highlight}</span> {hero.description}
      </h1>
      <p className="text-xl text-muted-foreground mb-8">{hero.callToAction}</p>
      <a
        href="#contact"
